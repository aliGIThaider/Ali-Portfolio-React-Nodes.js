                                      ...
                                      <ul className="no-top-padding">
                                        ...
                                        <ul className="no-top-padding">
                                          <li>
                                            ...
                                            <span className="html-2">Android Development</span>
                                          ...
                                          <li>
                                            &lt;<span className="html-1">li</span>&gt;
                                            <span className="html-2">PHP</span>
                                            &lt;/<span className="html-1">li</span>&gt;
                                          </li>
                                          <li>
                                            &lt;<span className="html-1">li</span>&gt;
                                            <span className="html-2">UI-UX</span>
                                            &lt;/<span className="html-1">li</span>&gt;
                                          </li>
                                          <li>
                                            &lt;<span className="html-1">li</span>&gt;
                                            <span className="html-2">Webpacks </span>
                                            &lt;/<span className="html-1">li</span>&gt;
                                          </li>
                                          <li>
                                            &lt;<span className="html-1">li</span>&gt;
                                          ...
                                          <li>
                                            &lt;<span className="html-1">li</span>&gt;
                                            <span className="html-2">Java Script</span>
                                            &lt;/<span className="html-1">li</span>&gt;
                                          </li>
                                          <li>
                                            &lt;<span className="html-1">li</span>&gt;
